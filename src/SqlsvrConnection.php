...
use Hyperf\Database\Sqlsvr\Query\Grammars\SqlsvrGrammar as SqlsvrQueryGrammar;
use Hyperf\Database\Sqlsvr\Schema\SqlsvrBuilder as SqlsvrSchemaBuilder;
use PDO;

class SqlsvrConnection extends Connection
{
    /**
